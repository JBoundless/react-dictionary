    ...
    <section className="max-w-2xl mx-auto p-5">
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        <input
          ...
          required
          className="py-2 px-4 border-b-2 border-blue-400 outline-none focus_border-blue-600 transition w-full text-xl lg:text-2xl"
          value={word}
          ...
          <ul className="mt-8 flex flex-col gap-4">
            {words.phonetics.map((phonetic, index) => (
              <React.Fragment key={index}>
                <li className="font-bold text-xl text-slate-500 ml-4">
                  {phonetic.text}
                </li>
                <audio controls>
